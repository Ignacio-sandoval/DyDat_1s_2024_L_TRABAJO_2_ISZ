...
Para una visualización detallada y de alta calidad de los componentes, consulte el [modelo de datos en formato PDF](Modelo de Datos.pdf) disponible en el repositorio.
